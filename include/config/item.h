...
// randolocke: TRUE. The species data gives every held-item trade evolution an item route
// (Onix + Metal Coat, Seadra + Dragon Scale, ...) and the marts sell every such item, but
// with this FALSE those items are "can't use" in the bag -- so without a link cable none of
// those evolutions could happen at all. The Linking Cord was always usable; these were not.
