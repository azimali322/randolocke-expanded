...
// randolocke: the bigger bag needs room in SaveBlock1, which was already full. These are
// all link, Mystery Gift and Battle Frontier side-features that a single-player randomizer
// run never touches, and freeing them is exactly what RHH provides these switches for.
// SaveBlock1 configs
