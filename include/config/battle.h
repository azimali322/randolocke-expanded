...
#define B_VAR_NO_BAG_USE         VAR_UNUSED_0x40F7  // randolocke: set this var to 1 to disable the Bag in trainer battles, 2 for wild too. // If set to 1, the ability to use the Bag is disabled in Trainer battles. If set to 2, it is also disabled in wild battles.
